...
ctx.lineWidth = 5;
ctx.arc(250, 210, 40, startAngle, endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(350, 210, 40, startAngle, endAngle);
ctx.stroke();
...
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(210, 40, 40, startAngle, endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(300, 250, 40, startAngle, endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(400, 250, 40, startAngle, endAngle);
ctx.stroke();